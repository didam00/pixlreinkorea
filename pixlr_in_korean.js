...
function pEiKTs() {
  ...
  $$(".menu a")[9].innerText = "편집"
    $$(".menu a")[10].innerHTML = "되돌리기" + $$(".menu a span")[7].outerHTML;
    ...
    $$(".menu a")[18].innerHTML = "변형"
      $$(".menu a")[19].innerHTML = "왼쪽으로 회전 / 시계 반대 방향"
      $$(".menu a")[20].innerHTML = "오른쪽으로 회전 / 시계 방향"
      $$(".menu a")[21].innerHTML = "좌우반전"
      $$(".menu a")[22].innerHTML = "상하반전"
    $$(".menu a")[23].innerHTML = "외곽선"
  ...
  $$(".menu a")[25].innerText = "이미지";
    ...
    $$(".menu a")[28].innerHTML = "이미지 회전";
      $$(".menu a")[29].innerHTML = "왼쪽으로 회전 / 시계 반대 방향";
      $$(".menu a")[30].innerHTML = "오른쪽으로 회전 / 시계 방향";
      $$(".menu a")[31].innerHTML = "좌우반전";
      $$(".menu a")[32].innerHTML = "상하반전";
